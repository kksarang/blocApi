...
/// @nodoc
class __$$InitialCopyWithImpl<T, $Res> extends _$ResultCopyWithImpl<T, $Res>
...
class _$Success<T> implements Success<T> {
  const _$Success(this.data, {this.message});
...
abstract class Success<T> implements Result<T> {
  const factory Success(final T data, {final String? message}) = _$Success<T>;
